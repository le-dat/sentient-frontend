export const TOKEN_DEFINITIONS = [
  ...
  { symbol: "LINK", name: "ChainLink Token", address: "0xE4aB69C077896252FAFBD49EFD26B5D171A32410", decimals: 18 },
  { symbol: "CCIP", name: "CCIP-BnM",        address: "0x88A2d74F47a237a62e7A51cdDa67270CE381555e", decimals: 18 },
...
export const TOKEN_DATA = Object.fromEntries(
  TOKEN_DEFINITIONS.map((t) => [t.symbol, t]),
) as Record<string, (typeof TOKEN_DEFINITIONS)[number]>;
